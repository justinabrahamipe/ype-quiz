  ...
  return (
    <Box sx={{ maxWidth: 900, mx: "auto", px: { xs: 1.5, sm: 3 }, py: 3, pb: 12 }}>
      ...
      {members.length >= 3 && members[0].score > 0 && (
        <Card elevation={0} sx={{ mb: 3, p: 3, background: "linear-gradient(135deg, rgba(99,102,241,0.04), rgba(139,92,246,0.04))" }}>
          <Box sx={{ display: "flex", alignItems: "flex-end", justifyContent: "center", gap: 2, pt: 2 }}>
            ...
            <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", width: 90 }}>
              <Avatar src={members[1].image || undefined} sx={{ width: 48, height: 48, mb: 1, border: "3px solid #94a3b8", background: !members[1].image ? "linear-gradient(135deg, #94a3b8, #64748b)" : undefined }}>
              ...
              <Box sx={{ width: "100%", height: 70, mt: 1, borderRadius: "8px 8px 0 0", background: "linear-gradient(to top, #94a3b8, #cbd5e1)", display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
            ...
            <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", width: 90 }}>
              ...
              <Avatar src={members[0].image || undefined} sx={{ width: 56, height: 56, mb: 1, border: "3px solid #f59e0b", background: !members[0].image ? "linear-gradient(135deg, #f59e0b, #d97706)" : undefined }}>
              ...
              <Box sx={{ width: "100%", height: 100, mt: 1, borderRadius: "8px 8px 0 0", background: "linear-gradient(to top, #f59e0b, #fbbf24)", display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
                <Typography variant="h5" sx={{ pb: 1, color: "white", fontWeight: 800 }}>1</Typography>
              </Box>
            </Box>
            {/* 3rd */}
            <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", width: 90 }}>
              <Avatar src={members[2].image || undefined} sx={{ width: 48, height: 48, mb: 1, border: "3px solid #d97706", background: !members[2].image ? "linear-gradient(135deg, #d97706, #b45309)" : undefined }}>
              ...
              <Box sx={{ width: "100%", height: 50, mt: 1, borderRadius: "8px 8px 0 0", background: "linear-gradient(to top, #d97706, #f59e0b)", display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
                  ...
                  <Box sx={{ display: "flex", alignItems: "center", gap: 1.5, mb: 1 }}>
                    ...
                    <Avatar
                      ...
                      sx={{
                        ...
                        height: 36,
                        fontSize: "0.85rem",
                        background: !member.image ? "linear-gradient(135deg, #6366f1, #8b5cf6)" : undefined,
                      }}
                    >
                    ...
                    <LinearProgress
                      ...
                      sx={{
                        ...
                        "& .MuiLinearProgress-bar": {
                          background: i === 0 ? "linear-gradient(90deg, #f59e0b, #fbbf24)" : i === 1 ? "linear-gradient(90deg, #94a3b8, #cbd5e1)" : i === 2 ? "linear-gradient(90deg, #d97706, #f59e0b)" : "linear-gradient(90deg, #6366f1, #8b5cf6)",
                          borderRadius: 3,
                        },
                      }}
                    />
